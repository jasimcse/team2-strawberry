...
@ManagedBean(name="dobavqneNaKlientDebug")
@RequestScoped
public class DobavqneNaKlient {
	...
	public String getForeignIDPerson() {
		return klientPerson.getForeignID();
	}

	public void setForeignIDPerson(String foreignID) {
		klientPerson.setForeignID(foreignID);
	}
	...
	public String getForeignIDCompany() {
		return klientCompany.getForeignID();
	}

	public void setForeignIDCompany(String foreignID) {
		klientCompany.setForeignID(foreignID);
	}
